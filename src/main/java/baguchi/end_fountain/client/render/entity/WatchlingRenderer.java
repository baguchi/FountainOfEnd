...
import baguchi.end_fountain.client.render.layer.WatchlingEyeLayer;
...
public class WatchlingRenderer extends MobRenderer<Watchling, WatchlingModel<Watchling>> {
    private static final ResourceLocation ENDERMAN_LOCATION = ResourceLocation.fromNamespaceAndPath(FountainOfEnd.MODID, "textures/entity/enderling/watchling.png");
