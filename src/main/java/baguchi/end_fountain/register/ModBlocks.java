...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> FOUNTAIN_OF_END = register("fountain_of_end", () -> new FountainOfEndBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(100.0F).noLootTable().sound(SoundType.NETHERRACK)));
