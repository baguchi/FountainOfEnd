...
public class EndSpreaderUtil {
    ...
    public EndSpreaderUtil(boolean p_222248_, TagKey<Block> p_222249_, int p_222250_, int p_222251_, int p_222252_, int p_222253_) {
    ...
    public static EndSpreaderUtil createLevelSpreader() {
        return new EndSpreaderUtil(false, BlockTags.OVERWORLD_CARVER_REPLACEABLES, 10, 1, 16, 5);
    }
    ...
    public static class ChargeCursor {
        ...
        public void update(LevelAccessor p_222312_, BlockPos p_222313_, RandomSource p_222314_, EndSpreaderUtil p_222315_, boolean p_222316_) {
            if (this.shouldUpdate(p_222312_, p_222313_, p_222315_.isWorldGeneration)) {
                if (this.updateDelay > 0) {
                    ...
                    EndBehaviour netherbehaviour = getBlockBehaviour(blockstate);
        ...
        private static EndBehaviour getBlockBehaviour(BlockState p_222334_) {
            Block block = p_222334_.getBlock();
            EndBehaviour netherbehaviour1;
            if (block instanceof EndBehaviour netherbehaviour) {
                netherbehaviour1 = netherbehaviour;
            } else {
                netherbehaviour1 = EndBehaviour.DEFAULT;
            }
        ...
        private static BlockPos getValidMovementPos(LevelAccessor p_222308_, BlockPos p_222309_, RandomSource p_222310_) {
            ...
            for (Vec3i vec3i : getRandomizedNonCornerNeighbourOffsets(p_222310_)) {
                ...
                if (blockstate.is(ModTags.Blocks.MOVE_SPREAD) && isMovementUnobstructed(p_222308_, p_222309_, blockpos$mutableblockpos1)) {
