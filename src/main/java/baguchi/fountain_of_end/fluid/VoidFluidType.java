package baguchi.fountain_of_end.fluid;
...
public class VoidFluidType extends FluidType {
    public VoidFluidType(FluidType.Properties properties) {
        super(properties);
    }
    ...
    public static class VoidRender implements IClientFluidTypeExtensions {
        private static final ResourceLocation TEXTURE_STILL = ResourceLocation.fromNamespaceAndPath(FountainOfEnd.MODID, "block/void");
        private static final ResourceLocation TEXTURE_FLOW = ResourceLocation.fromNamespaceAndPath(FountainOfEnd.MODID, "block/void_flow");
        private static final ResourceLocation TEXTURE_OVERLAY = ResourceLocation.fromNamespaceAndPath(FountainOfEnd.MODID, "textures/block/void.png");
